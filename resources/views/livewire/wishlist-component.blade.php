    ...
    <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
        <div class="product product-style-3 equal-elem ">
            ...
            <div class="product-info">
                ...
                <a href="#" class="btn add-to-cart" wire:click.prevent="moveProductFromWishlistToCart('{{$item->rowId}}')">Chuyển đến giỏ hàng</a>
...
@else
    <h3 class="text-center">KHÔNG CÓ SẢN PHẨM YÊU THÍCH NÀO ĐƯỢC THÊM</h3>
@endif
</div>
