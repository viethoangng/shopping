		...
		<div class="update-cleared " style="float:right">
			...
			<div class="order-summary">
				...
				@if (Session::has('coupon'))  <!--nếu có mã  -->
					<p class="summary-info"><span class="title">Giảm giá({{Session::get('coupon')['code']}}) <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a> </span><b class="index"> -${{number_format($discount,2)}}</b></p>
					<p class="summary-info"><span class="title">Tổng sau khi đã giảm giá</span><b class="index">${{number_format($subtotalAfterDiscount,2)}}</b></p>
					<p class="summary-info"><span class="title">Thuế({{config('cart.tax')}}%)</span><b class="index">${{number_format($taxAfterDiscount,2)}}</b></p>
					<p class="summary-info total-info "><span class="title">Tổng</span><b class="index">${{number_format($totalAfterDiscount,2)}}</b></p>
