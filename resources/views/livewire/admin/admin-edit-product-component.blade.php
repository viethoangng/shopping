<div>
    <div class="container" style="padding:30px 0;">
        <div class="row">
            ...
            <!-- phuong thuc updateproduct đc tạo bên component ...wire... -->
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Mô tả chi tiết</label>
                            <div class="col-md-4" wire:ignore>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-md-4">
                                <select class="form-control" wire:model="stoeditor_status">
                                    <option value="instoeditor">InStoeditor</option>
                                    <option value="outofstoeditor">Out of Stoeditor</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
